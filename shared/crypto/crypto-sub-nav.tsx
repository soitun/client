...
const cryptoSubRoutes = {
  [Constants.decryptTab]: {getScreen: (): typeof Decrypt => require('./operations/decrypt').default},
  [Constants.encryptTab]: {getScreen: (): typeof Encrypt => require('./operations/encrypt').default},
